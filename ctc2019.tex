...
\only<1|handout 0>{
  \begin{center}
    ...
    \textbf{AB} &        &             \\ \cline{2-3}
    \textbf{BB} &        &             \\ \cline{2-3}
    \multicolumn{1}{c}{} & \multicolumn{2}{c}{\color{white} percent discordance} \\
  ...
  \begin{center}
    ...
    \textbf{BB} &     2,128 & 375,559 \\ \cline{2-3}
     \multicolumn{1}{c}{} & \multicolumn{2}{c}{
       \only<3>{\hilit percent discordance = 0.3\%}} \\
    \multicolumn{1}{c}{} & \multicolumn{1}{c}{\hspace*{23mm}} &
            \multicolumn{1}{c}{\hspace*{23mm}}
  \end{tabular}
  \end{center}
...
\bigskip {\hilit genomic DO-360 vs microbiome DO-360}
  ...
  \begin{center}
    ...
    \textbf{BB} &   671,722 &  536,010  \\ \cline{2-3}
     \multicolumn{1}{c}{} & \multicolumn{2}{c}{\hilit percent discordance = 19\%} \\
    \multicolumn{1}{c}{} & \multicolumn{1}{c}{\hspace*{23mm}} &
            \multicolumn{1}{c}{\hspace*{23mm}}
  \end{tabular}
  \end{center}
...
\bigskip {\hilit genomic DO-370 vs microbiome DO-360}
  ...
  \begin{center}
    ...
    \textbf{BB} &      5,347 & 1,117,994 \\ \cline{2-3}
     \multicolumn{1}{c}{} & \multicolumn{2}{c}{\hilit percent discordance = 0.2\%} \\
    \multicolumn{1}{c}{} & \multicolumn{1}{c}{\hspace*{23mm}} &
            \multicolumn{1}{c}{\hspace*{23mm}}
  \end{tabular}
  \end{center}
