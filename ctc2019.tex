...
overlap a SNP, and the count the observed alleles at the different reads.
...
\note{
  ...
  In this particular case, the percent mismatches in the homozygous
...
\note{
   ...
   clearly different pattern: 19\% mismatch in the homozygous SNPs,
...
\note{
   ...
   going to just focus on homozygous SNPs and use the percent mismatch
...
\note{
  ...
  Samples on the diagonal (in light blue) look to be
...
\note{
    ...
    sample DO-362 should only depend on the genotype of DO-362 and not
...
\note{
  ...
  This figure shows the estimated proportion contaminant (on the
...
\note{
  ...
  $p=0$ (on the y-axis) vs.\ the estimated contaminant proportion (on
